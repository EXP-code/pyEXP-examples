"""
an example script to bring in a Hernquist basis and fill a coefficient file with externally-generated coefficients
(e.g. from gala)
...
hernquist_rs = 15.
R,D,M,P = makemodel(twopower_density,1.,[hernquist_rs,1,3],rvals = 10.**np.linspace(-1.,3.,2000),pfile='Hernquist_rs{}.dat'.format(hernquist_rs))
